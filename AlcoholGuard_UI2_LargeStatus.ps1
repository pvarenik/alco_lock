...
function Build-LockForm {
    ...
    $contentW=[int]([Math]::Min(860,$Screen.Bounds.Width*0.68)); $left=[int](($Screen.Bounds.Width-$contentW)/2); $top=[int]($Screen.Bounds.Height*0.075)
    $title=New-UiLabel -Width $contentW -Height 55 -Font (New-Object System.Drawing.Font('Segoe UI Semibold',30,[System.Drawing.FontStyle]::Bold)) -ForeColor ([System.Drawing.Color]::FromArgb(235,65,75)) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter)
    $title.Left=$left; $title.Top=$top; $title.Text='ALCOBLOCKER'; $form.Controls.Add($title)
    $sub=New-UiLabel -Width $contentW -Height 24 -Font (New-Object System.Drawing.Font('Segoe UI',10)) -ForeColor ([System.Drawing.Color]::FromArgb(145,155,170)) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter)
    $sub.Left=$left; $sub.Top=$top+54; $sub.Text='Breath control system'; $form.Controls.Add($sub)

    $status=New-UiLabel -Width $contentW -Height 68 -Font (New-Object System.Drawing.Font('Segoe UI Semibold',25,[System.Drawing.FontStyle]::Bold)) -ForeColor ([System.Drawing.Color]::White) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter)
    $status.Left=$left; $status.Top=$top+94; $status.Text='Connect sensor'; $form.Controls.Add($status); $script:StatusLabels += $status
    $stateLabel=New-UiLabel -Width 240 -Height 24 -Font (New-Object System.Drawing.Font('Segoe UI',9)) -ForeColor ([System.Drawing.Color]::FromArgb(145,155,170)) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter)
    $stateLabel.Left=$left; $stateLabel.Top=$top+164; $stateLabel.Text='State: NoSensor'; $form.Controls.Add($stateLabel); if($IsPrimary){$script:StateLabel=$stateLabel}
    $portLabel=New-UiLabel -Width 240 -Height 24 -Font (New-Object System.Drawing.Font('Segoe UI',9)) -ForeColor ([System.Drawing.Color]::FromArgb(145,155,170)) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter)
    $portLabel.Left=$left+$contentW-240; $portLabel.Top=$top+164; $portLabel.Text='Sensor: -'; $form.Controls.Add($portLabel); if($IsPrimary){$script:NextCheckLabel=$portLabel}

    $valueCaption=New-UiLabel -Width $contentW -Height 28 -Font (New-Object System.Drawing.Font('Segoe UI',9)) -ForeColor ([System.Drawing.Color]::FromArgb(135,145,160)) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter)
    $valueCaption.Left=$left; $valueCaption.Top=$top+205; $valueCaption.Text='CURRENT READING'; $form.Controls.Add($valueCaption)
    $valueLabel=New-UiLabel -Width $contentW -Height 130 -Font (New-Object System.Drawing.Font('Segoe UI Semibold',76,[System.Drawing.FontStyle]::Bold)) -ForeColor ([System.Drawing.Color]::White) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter)
    $valueLabel.Left=$left; $valueLabel.Top=$top+226; $valueLabel.Text='-'; $form.Controls.Add($valueLabel); if($IsPrimary){$script:CurrentValueLabel=$valueLabel}

    $metricY=$top+365; $gap=12; $mw=[int](($contentW-($gap*2))/3)
    function Add-BigMetric { param([int]$Left,[string]$Caption)
        $panel=New-Object System.Windows.Forms.Panel; $panel.Width=$mw; $panel.Height=86; $panel.Left=$Left; $panel.Top=$metricY; $panel.BackColor=[System.Drawing.Color]::FromArgb(24,30,39); $form.Controls.Add($panel)
        $cap=New-UiLabel -Width ($mw-20) -Height 20 -Font (New-Object System.Drawing.Font('Segoe UI',8)) -ForeColor ([System.Drawing.Color]::FromArgb(135,145,160)) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter); $cap.Left=10;$cap.Top=7;$cap.Text=$Caption;$panel.Controls.Add($cap)
        $val=New-UiLabel -Width ($mw-20) -Height 44 -Font (New-Object System.Drawing.Font('Segoe UI Semibold',19,[System.Drawing.FontStyle]::Bold)) -ForeColor ([System.Drawing.Color]::White) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter);$val.Left=10;$val.Top=30;$val.Text='-';$panel.Controls.Add($val); return $val
    }
    $baselineLabel=Add-BigMetric -Left $left -Caption 'CLEAN-AIR BASELINE'; if($IsPrimary){$script:BaselineLabel=$baselineLabel}
    $alcoholLabel=Add-BigMetric -Left ($left+$mw+$gap) -Caption 'ALCOHOL THRESHOLD'; if($IsPrimary){$script:AlcoholValueLabel=$alcoholLabel}
    $rangeLabel2=Add-BigMetric -Left ($left+($mw+$gap)*2) -Caption 'BREATH RANGE'; if($IsPrimary){$script:ThresholdLabel=$rangeLabel2}

    $rangePanel=New-Object System.Windows.Forms.Panel; $rangePanel.Width=$contentW; $rangePanel.Height=62; $rangePanel.Left=$left; $rangePanel.Top=$metricY+102; $rangePanel.BackColor=[System.Drawing.Color]::FromArgb(24,30,39); $form.Controls.Add($rangePanel)
    $rangeValue=New-UiLabel -Width ($contentW-20) -Height 40 -Font (New-Object System.Drawing.Font('Segoe UI Semibold',13,[System.Drawing.FontStyle]::Bold)) -ForeColor ([System.Drawing.Color]::White) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter); $rangeValue.Left=10;$rangeValue.Top=11;$rangeValue.Text='Observed range: Min -    Max -';$rangePanel.Controls.Add($rangeValue);$script:RangeLabel=$rangeValue

    if($IsPrimary){
        $passwordPanel=New-Object System.Windows.Forms.Panel;$passwordPanel.Width=$contentW;$passwordPanel.Height=112;$passwordPanel.Left=$left;$passwordPanel.Top=$metricY+204;$passwordPanel.BackColor=[System.Drawing.Color]::FromArgb(24,30,39);$form.Controls.Add($passwordPanel)
        ...
        $passwordWidth=240; $buttonWidth=140; $gap2=12; $groupWidth=$passwordWidth+$gap2+$buttonWidth; $groupLeft=[int](($contentW-$groupWidth)/2)
        ...
        $button=New-Object System.Windows.Forms.Button;$button.Width=$buttonWidth;$button.Height=32;$button.Left=$groupLeft+$passwordWidth+$gap2;$button.Top=32;$button.Text='Unlock';$button.Font=New-Object System.Drawing.Font('Segoe UI Semibold',9);$button.FlatStyle=[System.Windows.Forms.FlatStyle]::Flat;$button.FlatAppearance.BorderSize=0;$button.BackColor=[System.Drawing.Color]::FromArgb(45,120,210);$button.ForeColor=[System.Drawing.Color]::White;$button.Add_Click({Unlock-WithPassword});$passwordPanel.Controls.Add($button);$script:PasswordButton=$button
        ...
        $controlPanel=New-Object System.Windows.Forms.Panel;$controlPanel.Width=$contentW;$controlPanel.Height=84;$controlPanel.Left=$left;$controlPanel.Top=$passwordPanel.Bottom+12;$controlPanel.BackColor=[System.Drawing.Color]::FromArgb(24,30,39);$form.Controls.Add($controlPanel)
        $refreshButton=New-Object System.Windows.Forms.Button;$refreshButton.Width=[int]($contentW*0.62);$refreshButton.Height=34;$refreshButton.Left=[int](($contentW-$refreshButton.Width)/2);$refreshButton.Top=25;$refreshButton.Text='Refresh baseline & retest';$refreshButton.Font=New-Object System.Drawing.Font('Segoe UI Semibold',9);$refreshButton.FlatStyle=[System.Windows.Forms.FlatStyle]::Flat;$refreshButton.FlatAppearance.BorderSize=0;$refreshButton.BackColor=[System.Drawing.Color]::FromArgb(45,150,105);$refreshButton.ForeColor=[System.Drawing.Color]::White;$refreshButton.Add_Click({Request-BaselineRefresh});$controlPanel.Controls.Add($refreshButton);$script:RefreshBaselineButton=$refreshButton
    }
    $nextValue=New-UiLabel -Width $contentW -Height 24 -Font (New-Object System.Drawing.Font('Segoe UI',9)) -ForeColor ([System.Drawing.Color]::FromArgb(135,145,160)) -TextAlign ([System.Drawing.ContentAlignment]::MiddleCenter);$nextValue.Left=$left;$nextValue.Top=$metricY+170;$nextValue.Text='Next check: -';$form.Controls.Add($nextValue);$script:NextHourLabel=$nextValue
    $script:Forms += $form
    return $form
}
...
function Invoke-SelfTest {
    ...
    Write-Host '=== AlcoholGuard SelfTest AlcoholGuard_UI2_LargeStatus ===' -ForegroundColor Cyan
